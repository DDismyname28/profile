...
<html>
<head>
<title>Lookz an E-Commerce online Shopping Category Flat Bootstarp responsive Website Template| Cart :: w3layouts</title>
		  ...
		  <div class="header_bottom_right">
			<div class="search">
	  		...
	  		<ul class="bag">
	  			...
	  			<a href="cart.php"><li class="bag_right"><p>$<?php ?> </p> </li></a>
	  			<div class="clearfix"> </div>
	  		</ul>
	  		<div class="clearfix"> </div>
		   </div>
...
<div class="content">
  <div class="content_box">
	<div class="men cart">
	    <h1>Product List</h1>
		<?php cart_items($connection); ?>
		<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
			<input type="hidden" name="cmd" value="_cart">
			<input type="hidden" name="business" value="idie4drumz-merchant@gmail.com">
			<input type="hidden" name="upload" value="1">
			<input type="hidden" name="return" value="<?php echo "http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]";?>">
			
			<?php paypal($connection); ?>
			
			<input type="image" name="submit" src="https://www.paypalobjects.com/webstatic/en_US/i/buttons/buy-logo-large.png">
		</form>
