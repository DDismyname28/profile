...
<html>
<head>
<title>Lookz an E-Commerce online Shopping Category Flat Bootstarp responsive Website Template| Register :: w3layouts</title>
			...
			<div class="col-sm-3 header-top-right">
			     <div class="drop_buttons">
   			    ...
   			    <div class="register-info">
				    <ul>
						<li><a href="admin/logout.php"><?php echo $return; ?></a></li>
					</ul>
			    </div>
				<div class="clearfix"> </div>
   			 </div>
...
<div class="content">
  <div class="content_box">
	<div class="men">
	 <div class="register">
			<p>Welcome <?php echo session_user($connection); ?></p>
		  	  <form method="POST" enctype="multipart/form-data"> 
				 <div class="register-top-grid">
					<h1>PRODUCT INFORMATION</h1>
						<?php echo "<span>" .$query_message . "</span>"; ?>
					<div>
					 ...
					 <div class="row_6" style="float:none;">
						<span>PRODUCT DESCRIPTION<label>*</label></span>
						<textarea name="products_description" class="textarea" placeholder=""></textarea> 
					 </div>
