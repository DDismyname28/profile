...
<html>
<head>
<title>Lookz an E-Commerce online Shopping Category Flat Bootstarp responsive Website Template| Single :: w3layouts</title>
	  ...
	  <div class="single_top">
	       <div class="col-md-9 single_right">
						...
						<ul id="etalage">
							<li>
								<a href="optionallink.php">
									<img class="etalage_thumb_image" src="images/<?php echo $products[4]; ?>" class="img-responsive" />
									<img class="etalage_source_image" src="images/<?php echo $products[4]; ?>" class="img-responsive" title="" />
								</a>
							</li>
							<li>
				  ...
				  <div class="desc1 span_3_of_2">
				    ...
				    <?php echo '<p class="m_5">$' . $products[2] . '<a href="#">click for offer</a></p>'; ?>
				    <div class="btn_form">
						<form method="GET">
							<input type="hidden" value="<?php echo $products[5]; ?>" title="" name ="id">
							<input type="hidden" value="<?php echo $products[4]; ?>" title="" name ="image">
							<input type="hidden" value="<?php echo $products[6]; ?>" title="" name ="price">
							
							<input type="submit" value="<?php //$added; ?>BUY" title="" name="buy">
						</form>
					 </div>
					 <span class="m_link"><a href="#">login to save in wishlist</a> </span>
     	<?php echo '<p class="m_text2">'. $products[3] . '</p>'; ?>
				  </div>
				  <div class="clearfix"></div>	
       </div>
       <div class="col-md-3">
      	<!-- FlexSlider -->
              <section class="slider_flex">
				  <div class="flexslider">
					<ul class="slides">
						<?php fetch_all_image($connection); ?>
				    </ul>
				  </div>
	          </section>
<!-- FlexSlider -->
      ...
      <div class="clearfix"> </div>
       ...
       <div class="toogle">
     	...
     	<?php echo '<p class="m_text2">'. 'Price : $' . $products[2] . '<br />' . 'Product Name : ' . $products[1] . '</p>'; ?>
     </div>
     <div class="toogle">
